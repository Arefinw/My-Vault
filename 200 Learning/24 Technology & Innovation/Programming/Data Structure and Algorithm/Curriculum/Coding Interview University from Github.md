...
[Coding Interview University](https://github.com/jwasham/coding-interview-university?tab=readme-ov-file#heap--priority-queue--binary-heap)
...
1. Open one of the [[#Interview Prep Books]] (or coding problem websites, listed below)
...
[[#3. Do Coding Interview Questions While You're Learning|Then go back and read this.]]
...
Don't forget your key coding interview books [[#Interview Prep Books]].
